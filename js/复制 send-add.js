...
function lRight(data) {
	for(var i = 0; i < data.length; i++) {
		var item = data[i];
		if(item.children.length > 0 && item.last != true) {
			lRight(item.children);
		} else {
			if((item.last == true || oldSearch) && item.active == true) {
				var parentName = '';
				if(getParentName(item.group)) {
...
////		console.log($(".to__right .render").html());
//
//
...
////
////				
////			if(aArray.is(':checked')){
//////				console.log(aArray.checked )
////				console.log(aArray[j])
////					
//////					console.log(aArray.val())
//////					console.log(inval[i].html())
////				
//////				if(inval[i].html() != aArray[j].val()){
//////////
//////				$(inval[i]).click();
//////				}
////			}
...
////
////	}
//		var aval = $("input:checkbox[name='cName']:checked");
//
//		
//		var inval =$("#rightCont .render");
//		for(var i=0;i<inval.length;i++){
//			for(var j=0;j<aval.length;j++){
//				if(aval.is(':checked')){
//				console.log(aval.eq(j).val(),inval.eq(i).html())
//				if(aval.eq(j).length == inval.eq(i).length){
//					console.log(aval.eq(j).val())
//				}else{
//					aval.eq(j).click();
//				}
//			}
